...
public class PremiumAdvertiesmentController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ImagePattern imgPat1=new ImagePattern(new Image("com/coinnet/assets/brand1.png"));
        circle1.setFill(imgPat1);
        
        ImagePattern imgPat2=new ImagePattern(new Image("com/coinnet/assets/brand2.jpg"));
        circle2.setFill(imgPat2);
        
        ImagePattern imgPat3=new ImagePattern(new Image("com/coinnet/assets/brand3.jpg"));
