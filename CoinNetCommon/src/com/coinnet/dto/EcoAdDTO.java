 ...
 * @author Vidurajith
 */
public class EcoAdDTO extends SuperDTO{
    ...
    public String toString() {
        return "EcoAdDTO{" + "ecoId=" + ecoId + ", adId=" + adId + ", image=" + image + ", backImage=" + backImage + ", areaFontColor=" + areaFontColor + ", areaFontSize=" + areaFontSize + ", isAreaItalic=" + isAreaItalic + ", isAreaReg=" + isAreaReg + ", isAreaBold=" + isAreaBold + ", areaFamily=" + areaFamily + ", lblBack=" + lblBack + ", lblText=" + lblText + ", areaText=" + areaText + ", lblFontColor=" + lblFontColor + ", lblFontSize=" + lblFontSize + ", lblFamily=" + lblFamily + ", isLblBold=" + isLblBold + ", isLblItalic=" + isLblItalic + ", isLblReg=" + isLblReg + ", backColor=" + backColor + '}';
    }
